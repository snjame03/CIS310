...
--71
select Book_Num, Book_Title, Book_Cost AS Replacement_Cost
from BOOK
...
FROM CHECKOUT
WHERE CHECK_OUT_DATE < '5-APR-2015'
...
ORDER BY BOOKS_IN_SUBJECT DESC, BOOK_SUBJECT ASC

--94
SELECT AU_ID, COUNT(AU_ID)
AS BOOKS_WRITTEN
FROM WRITES
GROUP BY AU_ID
